...
Welcome to ``chess`` contributor's guide.
...
If you experience bugs or general issues with ``chess``, please have a look
...
You can help improve ``chess`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``chess`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``chess``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n chess python=3 six virtualenv pytest pytest-cov
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/chess.git
    cd chess
...
#. Install |pre-commit|_::
   ...
   ``chess`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/chess
.. _issue tracker: https://github.com/<USERNAME>/chess/issues
.. <-- end -->
